    ...
    >
      <div className="h-64 relative overflow-hidden bg-[#052553]/60">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-36 h-36 rounded-full overflow-hidden border-2 border-[#00F5FF]/70 shadow-[0_0_15px_rgba(0,245,255,0.4)]">
            {member.imageUrl ? (
              <img
                src={member.imageUrl}
                alt={member.name}
                className="w-full h-full object-contain bg-[#031835]"
              />
            ) : (
